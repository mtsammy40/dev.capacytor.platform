...
import dev.capacytor.auth.utils.Jwks;
...
public class AuthorizationServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository(ClientRepository clientRepository) {
        return new MongoRegisteredClientRepository(clientRepository);
    }
    ...
    @Bean
    public OAuth2AuthorizationService authorizationService(AuthorizationTokenRepository authorizationTokenRepository, RegisteredClientRepository registeredClientRepository) {
        return new MongoOauth2AuthorizationService(authorizationTokenRepository, registeredClientRepository);
    }
    ...
    public OAuth2AuthorizationConsentService authorizationConsentService(AuthorizationConsentRepository authorizationConsentRepository, RegisteredClientRepository registeredClientRepository) {
        return new Mongo0auth2AuthorizationConsentService(authorizationConsentRepository, registeredClientRepository);
    }
